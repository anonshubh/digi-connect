"""
Django settings for digi_connect_src project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'fdc)p(53y&c%(h2d%pksb!4(rv6-^q*qjswzg_kzvj3ft5+4=2')
...
ROOT_URLCONF = 'digi_connect_src.urls'
...
WSGI_APPLICATION = 'digi_connect_src.wsgi.application'
